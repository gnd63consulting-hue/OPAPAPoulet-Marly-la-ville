...
function MenuSection() {
  ...
  const menus = [
    ...
    { name: 'Papa Crousty', price: '10€', description: 'Papa crousty + 1 boisson', badge: 'BEST-SELLER', image: 'https://drive.google.com/uc?export=view&id=1WAUvDAuBSJ9cjT76S7HH_zrujN511BOj', emoji: '🍗' },
